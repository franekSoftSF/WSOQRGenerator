 ...
 * (c) 2012 Ryan Day, MIT License - see LICENSE-qrcode.txt
 * Bundled with esbuild from the same package the WSO QR admin panel uses,
 * so both produce byte-identical QR codes.
 */
